...
const TITLES = {
  ...
  volumes: { title: "Volumes", subtitle: "Persistent storage for containers" },
  networks: { title: "Networks", subtitle: "Docker networks on this node" },
...
const NODE_SCOPED_PAGES = new Set(["containers", "monitoring", "images", "volumes", "networks", "stacks", "compose"]);
      ...
      <div className="main">
        <div className="topbar">
          ...
          <div className="flex-row">
            {(page === "containers" || page === "monitoring" || page === "images" || page === "volumes" || page === "networks" || page === "stacks") && (
              <EnvironmentSwitcher />
            )}
            <NotificationBell />
            <UserMenu />
