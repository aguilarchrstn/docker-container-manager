      ...
      {networks.length === 0 ? (
        ...
        <div className="resource-table">
          <div className="resource-table-header" style={{ gridTemplateColumns: GRID }}>
            <span>Name</span>
            <span className="col-center">Driver</span>
            <span className="col-center">Subnet</span>
            <span className="col-center">Containers</span>
            <span></span>
          </div>
          {networks.map((n) => (
            <div className="resource-table-row" style={{ gridTemplateColumns: GRID }} key={n.id}>
              <span className="mono">{n.name}</span>
              <span className="col-center">{n.driver}</span>
              <span className="field-hint col-center">{n.subnet || "—"}</span>
              <span className="col-center">{n.containerCount}</span>
