        ...
        <>
          <div className="data-table">
            <div className="data-table-header">
              ...
              <button className="data-table-sort col-center" onClick={() => toggleSort("tags")}>Tags {sortArrow("tags")}</button>
              <button className="data-table-sort col-center" onClick={() => toggleSort("size")}>Size {sortArrow("size")}</button>
              <button className="data-table-sort col-center" onClick={() => toggleSort("created")}>Created {sortArrow("created")}</button>
              <span></span>
            </div>
            {pageItems.map((img) => (
              <div className="data-table-row" key={img.id}>
                ...
                <span className="status-label col-center">{formatBytes(img.size)}</span>
                <span className="field-hint col-center">{formatDate(img.created)}</span>
