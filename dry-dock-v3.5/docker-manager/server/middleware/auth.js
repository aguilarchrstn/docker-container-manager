...
// Attaches req.user (without passwordHash) and req.permissions (a Set) when
// a valid session cookie is present. Does NOT itself reject the request —
// use requireAuth / requirePermission for that — so routes like /api/health
// can stay public.
