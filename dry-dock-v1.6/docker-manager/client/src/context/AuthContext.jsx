...
export function AuthProvider({ children }) {
  ...
  async function logout() {
    try {
      ...
      // Session was already invalid server-side (e.g. expired) — the
      // onUnauthorized handler above already clears state in that case,
      // this just makes sure it happens even if that race doesn't land.
    }
    setUser(null);
    setPermissions(new Set());
    setSessionExpired(false);
